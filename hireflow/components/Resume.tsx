...
import { generateSummary } from '@/app/actions/action';
...
// TO DOs
  // 1. fill up a form and generate a resume
  // 2. edit the resume manually or with AI
  // 3. upload an existing resume
  // 4. Have AI score the resume and improve it or generate another one
  // 5. export the generated resume in different formats
